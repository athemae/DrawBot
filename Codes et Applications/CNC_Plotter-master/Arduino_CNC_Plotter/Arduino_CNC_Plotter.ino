...
const int penZUp = 100;                 // Angle servomoteur, crayon relevé
const int penZDown = 0;                            // Angle servomoteur, crayon baissé
const int penServoPin = 9;              // Pin sur lequel est relié le servomoteur
const int stepsPerRevolution = 20;              // Valeur par défaut
const int vitesseDeplacement = 500;             // Vitesse de déplacement des axes X et Y
...
float StepsPerMillimeterX = 4*6.0;
float StepsPerMillimeterY = 4*6.0;
/*
